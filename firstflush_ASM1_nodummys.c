...
{
    ssSetNumContStates(    S, 7);   /* number of continuous states                      (x[0] = TSS; x[1] = XI; x[2] = XS; x[3] = XBH; x[4] = XBHA; x[5] = XU; x[6] = XND;                                */
    ssSetNumDiscStates(    S, 0);   /* number of discrete states                                                        */
    ssSetNumInputs(        S, 8);  /* number of inputs                                  (u[0] = Q; u[1] = TSS, u[2-8] = XI, XS, XBH, XBA, XU, XND)       */
    ssSetNumOutputs(       S, 15);  /* number of outputs                                (y[0] = Q; y[1 -7] = TSS, XI, XS, XBH, XBA, XU, XND ; y[8-14] = mass of TSS, XI, XS, XBH, XBA, XU, XND) */
...
Hill=pow(u[0]/10000,n)/(pow(Q_lim/10000,n)+pow(u[0]/10000,n));
  ...
  y[8]=x[0];                /* Internal state, mass of sediment (TSS) stored in the sewer (kg COD)*/
  y[9]=x[1]/1000;           /* Internal state, mass of sediment XI stored in the sewer (kg COD)*/
  y[10]=x[2]/1000;          /* Internal state, mass of sediment XS stored in the sewer (kg COD)*/
  y[11]=x[3]/1000;          /* Internal state, mass of sediment XBH stored in the sewer (kg COD)*/
  y[12]=x[4]/1000;          /* Internal state, mass of sediment XBA stored in the sewer (kg COD)*/
  y[13]=x[5]/1000;          /* Internal state, mass of sediment XP stored in the sewer (kg COD)*/
  y[14]=x[6]/1000;          /* Internal state, mass of sediment XND stored in the sewer (kg N)*/

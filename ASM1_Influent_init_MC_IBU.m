...
%      day_number_finish = day_number_init + 24;
%      AADF_matrix(i,1) =  mean(ASM1_Influentpart(day_number_init:day_number_finish ,18));
%      init_value = 95 * i;
%      
%  end
...
% 
save((strcat('influent_uncertainty_',num2str(a))),'ASM1_Influent') 

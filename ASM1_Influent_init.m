...
Cli_gperPEperd=78e-3;                       % Cli load in g /d per PE (kg SMX day-1 PE-1)CLi load measured average daily influent (original values = 78 mg day-1 1000 PE)
Ccj_gperPEperd=174e-3;                      % Ccj load in g /d per PE (kg SMX1 day-1 PE-1)Ccj load measured average daily influent (original values = 78 mg day-1 1000 PE)
...
factorM = 2.0;                              % Proportionality factor random noise generators
...
ASM1_SEWERINIT =[zeros(1,18) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001 zeros(1,19) 0.001];
